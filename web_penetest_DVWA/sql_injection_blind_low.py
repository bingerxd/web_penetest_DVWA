...
VULN_URL = "http://localhost/DVWA/vulnerabilities/sqli_blind/"
USERNAME = "admin"
PASSWORD = "password"
...
def run_sqlmap():
    print("[*] Rozpoczynam atak SQL Injection (Blind) za pomocą sqlmap...")
    ...
    print(f"\n[+] Pobieranie listy baz danych za pomocą Blind SQLi...")
    ...
    print(f"\n[+] Pobieranie tabel z bazy danych 'dvwa' za pomocą Blind SQLi...")
    ...
    print(f"\n[+] Zrzut danych z tabeli 'users' za pomocą Blind SQLi...")
